...
**Resume**: `https://yeongwei.github.io/cv/v5/`

***

# Summary

Currently a Solution Architect with proven track records in designing, developing, and implementing complex enterprise grade solutions. Capable to perform in highly collaborative environment with cross-functional and cross-domain teams for delivering innovative, performant, scalable, reliable solutions. Demonstrated Thought-and-Technical Leadership in driving Teams toward Delivery Excellence. Comfortable with Private Cloud and Hybrid Cloud Systems, Legacy and Modern Architectures, API, and Integration Designs for massive solutions. Passionate about Technology. Aspired to be Enterprise Architect.
...
Database       |Oracle RDBMS, IBM DB2, MySQL, PostgreSQL, H2
Products       |IBM Netcool Operations Insight, IBM Cloud Pak for AIOps, IBM Cloud Pack for Network Automation, Dynatrace
Platforms      |AWS, Azure, Red Hat OpenStack, OpenShift and Ceph Storage Platforms, Open-source Ceph and Kubernetes Platforms
Programming    |Java, Scala, PHP, Perl, JavaScripts, HTML, CSS, Bash Shell Scripting, SQL, R Programming, Python  
Tools          |Ansible, Jenkins, Git, Docker, Kafka, NGINX, Cacti, Podman, Prometheus, Grafana, Terraform
...
_**Allianz Technology Sdn. Bhd. | Malaysia | Current**_

Responsible for the Design, Development and Implementing Solution Architectures for Digital Transformation Projects. IT Value Streams involvement: (1) Strategy to Portfolio (2) Requirement to Deploy (3) Request to Fulfill (4) Detect to Correct

* Transformation of Critical System: Output Management from on-premises to Cloud
* Health Operation Efficacy Improvement via Insurance Automation: Health Claims Copilot
* Core Insurance System Transformation for Property & Casualty Line of Business

## Consultant Architect

_**Vodafone Kabel Deutschland | Remote | 2024**_
...
_**U Mobile Sdn Bhd. | Malaysia | 2022 - 2004**_
...
_**TNPM Producte Development | Malaysia | 2010 - 2012**_
...
* Developed automation tools using Perl for generating TNPM Models in XML adhered to MVC practices.
...
--------------------|---------------------------------------------|-------------
The Digital Insurer     |CDI4 - Value Chain Innovations | September 2025
AWS     |AWS Certified SysOps Administrator – Associate (SOA-C02)| December 2024
AWS     |AWS Certified Developer - Associate (DVA-C02) | December 2024
AWS     |AWS Certified Solutions Architect – Associate (SAA-C03)| August 2024
