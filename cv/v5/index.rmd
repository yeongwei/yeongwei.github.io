...
Platforms      |Red Hat OpenStack, OpenShift and Ceph Storage Platforms, Open-source Ceph and Kubernetes Platforms
...
Developing and Implementing solution architectures for various Digital Transformation Projects. Responsible in S2P, R2D, R2F, D2C IT Value Streams.

* Cloudification of Critical System: Output Management
* Insurance Automation: Health Claims Copilot
* Core System Transformation for Property & Casualty Insurance Business
...
--------------------|---------------------------------------------|-------------
The Digital Insurer     | Value Chain Innocations | XXXX
AWS     |AWS Certified Developer – Associate (xxx-xxx)| December 2024
AWS     |AWS Cerfified SysOps Administartor – Associate (xxx-xxx)| December 2024
